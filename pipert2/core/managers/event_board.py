...
class EventBoard:
    ...
    def get_event_notifier(self) -> Callable:
        ...
        def notify_event(event_name, output_event_queue, routines_by_flow: dict = defaultdict(list), **params):
    ...
    def notify_event(self, event_name, routines_by_flow: dict = defaultdict(list), **params):
