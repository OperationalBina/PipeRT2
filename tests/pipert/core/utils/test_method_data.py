...
def test_is_contain_routines_with_specific_flow_with_routines(method_with_specific_flow_and_routines: Method):
    assert method_with_specific_flow_and_routines.is_apply_on_specific_routines("flow1")
